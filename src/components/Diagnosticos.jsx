  ...
  return (
    <div className="p-0 mt-2">
      ...
      <p className="mb-0 diagnostico-texto">
        ...
        un <strong>ESPECIALISTA</strong> te revisa los <strong>27 puntos</strong> más importantes de tu auto <strong>sin costo de mano de obra</strong> : partes mecánicas, fluidos y filtros, elementos de seguridad y lubricantes. Además tenes la posibilidad de ampliar el diagnóstico con un <strong>Escaneo Electrónico</strong> (Servicio Premium) con <strong>9 puntos</strong> de control por un adicional de $8500.
        Se entrega un <strong>certificado de producto y servicio</strong> garantizando la <strong>calidad del Lubricante</strong> utilizado. También se genera un <strong>historial del vehículo</strong> que te facilitara el mantenimiento y podras consultarlo en <strong>APP YPF</strong> y en toda la <strong>RED Boxes</strong> a nivel nacional.
      </p>
